      ...
      <div className="adm-grid adm-grid--3">
        ...
        <AdmCard title="Hızlı AI işlemleri">
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            <button className="adm-btn adm-btn--primary" onClick={() => go("reports")} style={{ height: "38px", borderRadius: "8px" }}><Icon name="ai" size={16} /> Haftalık rapor oluştur</button>
            <button className="adm-btn adm-btn--ghost" onClick={() => go("content")} style={{ height: "38px", borderRadius: "8px" }}><Icon name="blog" size={16} /> AI ile blog yazısı yaz</button>
            <button className="adm-btn adm-btn--ghost" onClick={() => go("appearance")} style={{ height: "38px", borderRadius: "8px" }}><Icon name="appearance" size={16} /> Görünümü düzenle</button>
          </div>
    ...
    return (
      <AdmCard title="AI İçgörü & Raporlar" desc={A().aiAvailable ? "Gerçek zamanlı AI analizi" : "Simülasyon modu"}>
        <div className="ai-panel">
          ...
          <button className="adm-btn adm-btn--primary" onClick={run} style={{ borderRadius: "8px", height: "38px" }}><Icon name="ai" size={15} /> Haftalık rapor oluştur</button>
        </div>
      </AdmCard>);
